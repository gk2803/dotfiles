...
#+begin_src emacs-lisp
  (use-package modus-themes
    ...
    (if (my-dark-theme-p) 
        (modus-themes-load-theme 'vscode-dark-plus)
      (modus-themes-load-theme 'modus-operandi))

    
    (setq modus-themes-to-toggle '(vscode-dark-plus modus-vivendi)))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (declare-function my-denote-zk "my-denote-zk" (&optional goto keys))
  (my-window-define-with-popup-frame my-denote-zk)

  ;;control firefox youtube-player from emacs
  (global-set-key (kbd "<XF86AudioPlay>")
    		(lambda () (interactive) (shell-command "~/.config/scripts/yt-control.sh space")))
  (global-set-key (kbd "<XF86AudioLowerVolume>")
    		(lambda () (interactive) (shell-command "~/.config/scripts/yt-control.sh Left")))
  (global-set-key (kbd "<XF86AudioRaiseVolume>")
    		(lambda () (interactive) (shell-command "~/.config/scripts/yt-control.sh Right")))
