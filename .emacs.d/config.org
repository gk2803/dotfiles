...
#+begin_src emacs-lisp
  ...
  (my-window-define-with-popup-frame org-capture)
  (add-hook 'org-capture-after-finalize-hook #'my-window-delete-popup-frame)

  (declare-function denote-inbox "my-denote-inbox" (&optional goto keys))
  (defvar denote-inbox-after-finalize-hook)
  (my-window-define-with-popup-frame my-denote-inbox)
  ;; (add-hook 'after-save-hook #'my-window-delete-popup-frame)
