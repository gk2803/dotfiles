...
#+begin_src emacs-lisp
  ...
  \\fi\n\n")
            ...
            (defun my-denote-template-function-for-latex-journal ()
      	 (format-time-string "\\section{%Y %d %B}")
      	 )



            (setq denote-templates
      	    `((math-journal . ,(concat (my-denote-template-function-for-latex-journal)
      				       "\n\n\n\n"
      				       "%%% Local Variables:"
      				       "\n"
      				       "%%% mode: LaTeX"
...
#+begin_src emacs-lisp
  (use-package denote-journal
    ...
    (defun my-denote-tech-journal-new-or-existing-entry()
      ...
      (interactive)
      (let ((denote-journal-keyword "techjournal")
            (denote-journal-directory "~/Nextcloud/Documents/publicNotes/tech journal")
            )
    ...
    (defun my-denote-math-journal-new-or-existing-entry()
      ...
      (let ((denote-journal-keyword "mathjournal")
            (denote-journal-directory "~/Nextcloud/Documents/publicNotes/math journal")
            (denote-file-type 'tex)
  	  (denote-use-template 'math-journal))
        (call-interactively #'denote-journal-new-or-existing-entry)
        (let ((buf (buffer-name)))
...
#+begin_src emacs-lisp
  ...
  (declare-function denote-journal "my-denote-journal" (&optional goto keys))
  (my-window-define-with-popup-frame denote-journal-new-or-existing-entry)

  (declare-function denote-tech-journal "my-denote-tech-journal" (&optional goto keys))
  (my-window-define-with-popup-frame my-denote-tech-journal-new-or-existing-entry)
