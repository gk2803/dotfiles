...
<<<<<<< HEAD
  	  (setq denote-known-keywords '(list "emacs" "math"))
=======
  	  (setq denote-known-keywords '("thoughts" "emacs" "math" "tech"))
>>>>>>> 2cb122c (control youtube player from emacs)
...
<<<<<<< HEAD
  (global-set-key (kbd "<f10>")
  		(lambda () (interactive) (shell-command "~/scripts/yt-move-5-secs.sh")))

  (global-set-key (kbd "<f11>")
  		(lambda () (interactive) (shell-command "~/scripts/yt-movef-5-secs.sh")))

  (global-set-key (kbd "<f12>")
  		(lambda () (interactive) (shell-command "~/scripts/yt-moveb-5-secs.sh")))
=======
